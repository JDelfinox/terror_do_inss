          ...
          Align(
            ...
            TextField(
              ...
              Align(
                        alignment: Alignment.topCenter,
                        child: Text(
                        ', Por favor selecione a opção que melhor descreve você: ',
                        style: TextStyle(
                          color: const Color.fromARGB(255, 0, 0, 0),
                          fontFamily: 'Helvetica', // Define a fonte personalizada
                          fontSize: 25, // Tamanho do texto (ajuste conforme necessário)
              ...
              SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: EdgeInsets.symmetric(vertical: 10.0),
                            backgroundColor: const Color.fromARGB(255, 230, 226, 5), // Cor do botão
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12.0),
                            ),
                          ),
              ...
              SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            padding: EdgeInsets.symmetric(vertical: 10.0),
                            backgroundColor: const Color.fromARGB(255, 175, 4, 4), // Cor do botão
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(12.0),
                            ),
                          ),
